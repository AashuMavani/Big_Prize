...
public class Big_Pager_Adapter_Small extends RecyclerView.Adapter<Big_Pager_Adapter_Small.ViewHolder> {
    ...
    public Big_Pager_Adapter_Small(Context context, List<Big_Home_Slider_Item> categorie) {
        this.list = categorie;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View viewItem = LayoutInflater.from(parent.getContext()).inflate(R.layout.big_item_home_slider_small, parent, false);
