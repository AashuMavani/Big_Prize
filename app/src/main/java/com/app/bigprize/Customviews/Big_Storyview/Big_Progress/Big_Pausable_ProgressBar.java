...
public final class Big_Pausable_ProgressBar extends FrameLayout {
    ...
    public Big_Pausable_ProgressBar(Context context) {
        this(context, null);
    }

    public Big_Pausable_ProgressBar(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public Big_Pausable_ProgressBar(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        LayoutInflater.from(context).inflate(R.layout.big_pausable_progress, this);
