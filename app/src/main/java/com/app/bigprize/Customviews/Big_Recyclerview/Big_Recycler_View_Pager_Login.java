...
public class Big_Recycler_View_Pager_Login extends RecyclerView {

    private int count;
    private Timer timer = new Timer();
    private Big_Pager_Adapter_Login adapter;
    ...
    public Big_Recycler_View_Pager_Login(@NonNull Context context) {
        super(context);
        initState();
    }


    public Big_Recycler_View_Pager_Login(@NonNull Context context, @Nullable AttributeSet attrs) {
    ...
    public Big_Recycler_View_Pager_Login(@NonNull Context context, @Nullable AttributeSet attrs, int defStyle) {
    ...
    public void start() {
        try {
            adapter = new Big_Pager_Adapter_Login(getContext(), pagerModels);
            setAdapter(adapter);
            if (runAuto) {
                if (timer == null)
                    timer = new Timer();
    ...
    public void setOnItemClickListener(Big_Pager_Adapter_Login.OnItemClickListener itemClickListener) {
        try {

            ((Big_Pager_Adapter_Login) getAdapter()).setOnclickItemListener(itemClickListener);
