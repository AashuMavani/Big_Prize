...
public class Big_PagerAdapterLoginWA extends RecyclerView.Adapter<Big_PagerAdapterLoginWA.ViewHolder> {
    ...
    public Big_PagerAdapterLoginWA(Context context, List<Big_Home_Slider_Item> categorie) {
        this.list = categorie;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View viewItem = LayoutInflater.from(parent.getContext()).inflate(R.layout.big_item_slider_image_whatsapp, parent, false);
