...
public class Big_Home_Story_Adapter extends RecyclerView.Adapter<Big_Home_Story_Adapter.ViewHolder> {

    private Activity activity;
    private List<Big_Home_Data_Item> data;
    private ClickListener clickListener;

    public Big_Home_Story_Adapter(final Activity context, List<Big_Home_Data_Item> data, ClickListener clickListener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.big_item_app_icons, parent, false);
