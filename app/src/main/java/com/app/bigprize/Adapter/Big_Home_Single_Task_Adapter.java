...
public class Big_Home_Single_Task_Adapter extends RecyclerView.Adapter<Big_Home_Single_Task_Adapter.ViewHolder> {
    ...
    public Big_Home_Single_Task_Adapter(final Activity context, List<Big_Home_Data_Item> data, String pointBgColor, String pointTextColor, ClickListener clickListener) {
        activity = context;
        this.data = data;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View v = null;
        v = LayoutInflater.from(parent.getContext()).inflate(R.layout.big_row_home_single_big_task, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (!BIG_Common_Utils.isStringNullOrEmpty(data.get(position).getLabel())) {
        ...
        if (data.get(position).getIsNewLable() != null && data.get(position).getIsNewLable().equals("1")) {
            holder.layoutContent.setBackground(activity.getDrawable(R.drawable.big_bg_icon_square));
        ...
        if (!BIG_Common_Utils.isStringNullOrEmpty(pointBgColor)) {
        ...
        if (!BIG_Common_Utils.isStringNullOrEmpty(pointTextColor)) {
        ...
        if (data.get(position).getDisplayImage() != null) {
            if (data.get(position).getDisplayImage().contains(".json")) {
                ...
                BIG_Common_Utils.setLottieAnimation(holder.animation_view, data.get(position).getDisplayImage());
