...
import com.app.bigprize.Async.Models.Big_Icon_ListItem;
...
public class Big_GiveawaySocialAdapter extends RecyclerView.Adapter<Big_GiveawaySocialAdapter.ViewHolder> {

    private Activity activity;
    private List<Big_Icon_ListItem> data;
    private ClickListener clickListener;

    public Big_GiveawaySocialAdapter(final Activity context, List<Big_Icon_ListItem> data, ClickListener clickListener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.big_item_giveaway_app_icons, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (!BIG_Common_Utils.isStringNullOrEmpty(data.get(position).getIcon())) {
            if (data.get(position).getIcon().contains(".json")) {
                ...
                BIG_Common_Utils.setLottieAnimation(holder.ivLottie, data.get(position).getIcon());
