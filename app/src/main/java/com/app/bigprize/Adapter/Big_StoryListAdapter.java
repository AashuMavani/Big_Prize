...
public class Big_StoryListAdapter extends RecyclerView.Adapter<Big_StoryListAdapter.ViewHolder> {

    private Activity activity;
    private List<Big_Home_Data_Item> data;
    private ClickListener clickListener;

    public Big_StoryListAdapter(final Activity context, List<Big_Home_Data_Item> data, ClickListener clickListener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.big_item_story_list, parent, false);
