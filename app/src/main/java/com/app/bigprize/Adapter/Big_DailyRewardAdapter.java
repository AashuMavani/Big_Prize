...
public class Big_DailyRewardAdapter extends RecyclerView.Adapter<Big_DailyRewardAdapter.SavedHolder> {

    public List<Big_Daily_Reward_Data_Item> listTasks;
    private Context context;
    private ClickListener clickListener;

    public Big_DailyRewardAdapter(List<Big_Daily_Reward_Data_Item> list, Context context, ClickListener clickListener) {
        this.listTasks = list;
    ...
    public SavedHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.big_item_daily_reward, parent, false);
    ...
    public void onBindViewHolder(@NonNull SavedHolder holder, final int position) {
        try {
            ...
            if (listTasks.get(position).getIsCompleted().equals("1")) {
                ...
                holder.btnAction.setCompoundDrawablesWithIntrinsicBounds(R.drawable.big_ic_done, 0, 0, 0);

                Drawable mDrawable = ContextCompat.getDrawable(context, R.drawable.big_bg_answer);
                ...
                Drawable mDrawableBG = ContextCompat.getDrawable(context, R.drawable.big_rectangle_white);
