...
public class Big_QuickTasksAdapter extends RecyclerView.Adapter<Big_QuickTasksAdapter.SavedHolder> {

    public List<Big_Home_Data_Item> listTasks;
    private Context context;
    private ClickListener clickListener;

    public Big_QuickTasksAdapter(List<Big_Home_Data_Item> list, Context context, ClickListener clickListener) {
        this.listTasks = list;
    ...
    public SavedHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.big_item_quick_tasks, parent, false);
