...
public class Big_AdjoeLeaderboardHistoryListAdapter extends RecyclerView.Adapter<Big_AdjoeLeaderboardHistoryListAdapter.SavedHolder> {
    private Big_Response_Model responseMain;
    public List<Big_AdjoeLeaderboardHistoryItem> listLeaderboard;
    private Context context;

    public Big_AdjoeLeaderboardHistoryListAdapter(List<Big_AdjoeLeaderboardHistoryItem> list, Context context) {
    ...
    public SavedHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.big_item_adjoe_leaderboard_history, parent, false);
    ...
    public void onBindViewHolder(@NonNull SavedHolder holder, final int position) {
        try {
            ...
            holder.tvDate.setText(BIG_Common_Utils.changeDateFormat("yyyy-MM-dd hh:mm:ss", "dd MMM, yyyy", listLeaderboard.get(position).getDeclarationDate()));
