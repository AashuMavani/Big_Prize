...
public class Big_Invite_Rules_Adapter extends RecyclerView.Adapter<Big_Invite_Rules_Adapter.ViewHolder> {

    private Activity activity;
    private ArrayList<Big_How_To_Work> data;
    private ClickListener clickListener;

    public Big_Invite_Rules_Adapter(final Activity context, List<Big_How_To_Work> data, ClickListener clickListener) {
        activity = context;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.big_item_refer_earn, parent, false);
...
*/
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private ImageView ivIcon, ivInfo,ivInfoivInfo;
