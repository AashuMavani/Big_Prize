...
public class Big_EarnGridAdapter extends RecyclerView.Adapter<Big_EarnGridAdapter.ViewHolder> {
    ...
    public Big_EarnGridAdapter(final Activity context, List<Big_Home_Data_Item> data, ClickListener clickListener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.big_row_earn_grid, parent, false);
