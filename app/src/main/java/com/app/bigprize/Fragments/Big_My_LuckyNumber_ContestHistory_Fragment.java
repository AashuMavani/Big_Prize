...
import com.app.bigprize.Adapter.Big_Lucky_Number_MyHistory_Adapter;
...
public class Big_My_LuckyNumber_ContestHistory_Fragment extends Fragment {
    private View view;
    ...
    private final List<Big_Lucky_Number_MyHistory_Item> listPointHistory = new ArrayList<>();
    ...
    public Big_My_LuckyNumber_ContestHistory_Fragment() {
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        rvHistoryList.setAdapter(new Big_Lucky_Number_MyHistory_Adapter(listPointHistory, getActivity()));
        ...
        nestedScrollView.setOnScrollChangeListener(new NestedScrollView.OnScrollChangeListener() {
            ...
            public void onScrollChange(NestedScrollView v, int scrollX, int scrollY, int oldScrollX, int oldScrollY) {
                if (scrollY == v.getChildAt(0).getMeasuredHeight() - v.getMeasuredHeight()) {
                    if (pageNo < numOfPage) {
                        new Big_Get_Lucky_Number_Point_History_Async(getActivity(), BIG_Constants.HistoryType.LUCKY_NUMBER_MY_CONTEST, String.valueOf(pageNo + 1));
                    }
                }
            }
        });
        new Big_Get_Lucky_Number_Point_History_Async(getActivity(), BIG_Constants.HistoryType.LUCKY_NUMBER_MY_CONTEST, String.valueOf(pageNo));
    }
