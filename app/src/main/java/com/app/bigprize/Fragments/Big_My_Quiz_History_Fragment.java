...
import com.app.bigprize.Adapter.Big_Quiz_My_History_Adapter;
...
public class Big_My_Quiz_History_Fragment extends Fragment {
    private View view;
    ...
    private final List<Big_Quiz_My_History_Item> listPointHistory = new ArrayList<>();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        rvHistoryList.setAdapter(new Big_Quiz_My_History_Adapter(listPointHistory, getActivity()));
        ...
        nestedScrollView.setOnScrollChangeListener(new NestedScrollView.OnScrollChangeListener() {
            ...
            public void onScrollChange(NestedScrollView v, int scrollX, int scrollY, int oldScrollX, int oldScrollY) {
                if (scrollY == v.getChildAt(0).getMeasuredHeight() - v.getMeasuredHeight()) {
                    if (pageNo < numOfPage) {
                        new Big_Get_Quiz_Point_History_Async(getActivity(), BIG_Constants.HistoryType.QUIZ_MY_CONTEST, String.valueOf(pageNo + 1));
                    }
                }
            }
        });
        new Big_Get_Quiz_Point_History_Async(getActivity(), BIG_Constants.HistoryType.QUIZ_MY_CONTEST, String.valueOf(pageNo));
    }
