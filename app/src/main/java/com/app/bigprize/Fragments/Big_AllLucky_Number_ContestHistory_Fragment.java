...
import com.app.bigprize.Adapter.Big_Lucky_Number_AllHistory_Adapter;
import com.app.bigprize.Async.Big_Get_Lucky_Number_Point_History_Async;
...
public class Big_AllLucky_Number_ContestHistory_Fragment extends Fragment {
    private View view;
    ...
    private final List<Big_Lucky_Number_AllHistory_Item> listPointHistory = new ArrayList<>();
    ...
    public Big_AllLucky_Number_ContestHistory_Fragment() {
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        rvHistoryList.setAdapter(new Big_Lucky_Number_AllHistory_Adapter(listPointHistory, getActivity()));
        ...
        nestedScrollView.setOnScrollChangeListener(new NestedScrollView.OnScrollChangeListener() {
            ...
            public void onScrollChange(NestedScrollView v, int scrollX, int scrollY, int oldScrollX, int oldScrollY) {
                if (scrollY == v.getChildAt(0).getMeasuredHeight() - v.getMeasuredHeight()) {
                    if (pageNo < numOfPage) {
                        new Big_Get_Lucky_Number_Point_History_Async(getActivity(), BIG_Constants.HistoryType.LUCKY_NUMBER_ALL_CONTEST, String.valueOf(pageNo + 1));
                    }
                }
            }
        });
        new Big_Get_Lucky_Number_Point_History_Async(getActivity(), BIG_Constants.HistoryType.LUCKY_NUMBER_ALL_CONTEST, String.valueOf(pageNo));
    }
