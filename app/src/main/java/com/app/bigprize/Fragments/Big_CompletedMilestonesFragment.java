...
import com.app.bigprize.Async.Big_GetPointHistoryAsync;
...
public class Big_CompletedMilestonesFragment extends Fragment {
    private View view;
    ...
    public Big_CompletedMilestonesFragment() {
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        rvHistoryList.setAdapter(new Big_Point_History_Adapter(listPointHistory, getActivity(), BIG_Constants.HistoryType.MILESTONES));
        ...
        nestedScrollView.setOnScrollChangeListener(new NestedScrollView.OnScrollChangeListener() {
            ...
            public void onScrollChange(NestedScrollView v, int scrollX, int scrollY, int oldScrollX, int oldScrollY) {
                if (scrollY == v.getChildAt(0).getMeasuredHeight() - v.getMeasuredHeight()) {
                    if (pageNo < numOfPage) {
                        new Big_GetPointHistoryAsync(getActivity(), BIG_Constants.HistoryType.MILESTONES, String.valueOf(pageNo + 1));
                    }
                }
            }
        });
        if (BIG_SharePrefs.getInstance().getBoolean(BIG_SharePrefs.IS_LOGIN)) {
            new Big_GetPointHistoryAsync(getActivity(), BIG_Constants.HistoryType.MILESTONES, String.valueOf(pageNo));
        } else {
            hideShowList();
        }
    }
