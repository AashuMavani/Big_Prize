...
public class Big_Refer_Point_History_Fragment extends Fragment {
    private View view;
    ...
    public Big_Refer_Point_History_Fragment() {
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        rvHistoryList.setAdapter(new Big_Point_History_Adapter(listPointHistory, getActivity(), BIG_Constants.HistoryType.REFER_POINT));
        ...
        nestedScrollView.setOnScrollChangeListener(new NestedScrollView.OnScrollChangeListener() {
            ...
            public void onScrollChange(NestedScrollView v, int scrollX, int scrollY, int oldScrollX, int oldScrollY) {
                if (scrollY == v.getChildAt(0).getMeasuredHeight() - v.getMeasuredHeight()) {
                    if (pageNo < numOfPage) {
                        new Big_Get_Point_History_Async(getActivity(), BIG_Constants.HistoryType.REFER_POINT, String.valueOf(pageNo + 1));
                    }
                }
            }
        });
        new Big_Get_Point_History_Async(getActivity(), BIG_Constants.HistoryType.REFER_POINT, String.valueOf(pageNo));
    }
