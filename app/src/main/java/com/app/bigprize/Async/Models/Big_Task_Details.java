...
public class Big_Task_Details {
    ...
    @Expose
    private List<Big_TaskOfferFootSteps> footstep;
    @Expose
    private List<Big_TaskOfferFootSteps> tncList;

    public List<Big_TaskOfferFootSteps> getFootstep() {
        return footstep;
    }

    public void setFootstep(List<Big_TaskOfferFootSteps> footstep) {
        this.footstep = footstep;
    }

    public List<Big_TaskOfferFootSteps> getTncList() {
        return tncList;
    }

    public void setTncList(List<Big_TaskOfferFootSteps> tncList) {
    ...
    public void setShareBtnNote(String shareBtnNote) {
    ...
    public void setShareTaskPoint(String shareTaskPoint) {
        ShareTaskPoint = shareTaskPoint;
    }
    ...
    public void setIsShareTask(String isShareTask) {
