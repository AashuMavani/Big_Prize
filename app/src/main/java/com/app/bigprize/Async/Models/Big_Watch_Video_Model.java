...
public class Big_Watch_Video_Model {
    @Expose
    ...
    @Expose
    private List<Big_Watch_Video_List> watchVideoList;
    @Expose
    private List<Big_Watch_Video_List> watchedVideoList;
    @Expose
    ...
    public List<Big_Watch_Video_List> getWatchVideoList() {
        return watchVideoList;
    }

    public void setWatchVideoList(List<Big_Watch_Video_List> watchVideoList) {
    ...
    public List<Big_Watch_Video_List> getWatchedVideoList() {
        return watchedVideoList;
    }

    public void setWatchedVideoList(List<Big_Watch_Video_List> watchedVideoList) {
