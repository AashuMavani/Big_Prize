...
public class Big_Daily_Bonus implements Serializable {
    ...
    @SerializedName("data")
    private List<Big_Daily_Bonus_Item> data;
    ...
    public List<Big_Daily_Bonus_Item> getData() {
        return data;
    }
    ...
    public void setData(List<Big_Daily_Bonus_Item> data) {
        this.data = data;
    }
