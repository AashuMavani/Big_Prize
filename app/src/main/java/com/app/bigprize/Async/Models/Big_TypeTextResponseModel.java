...
public class Big_TypeTextResponseModel implements Serializable {
    ...
    public Big_TypeTextItem getData() {
        return data;
    }

    public void setData(Big_TypeTextItem data) {
        this.data = data;
    }
