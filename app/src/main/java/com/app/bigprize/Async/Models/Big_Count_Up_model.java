...
public class Big_Count_Up_model implements Serializable {
...
//    }
    ...
    @Expose
    private List<Big_Count_Up_Item> data;
    @Expose
    ...
    public List<Big_Count_Up_Item> getData() {
        return data;
    }

    public void setData(List<Big_Count_Up_Item> data) {
        this.data = data;
    }
