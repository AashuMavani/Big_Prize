...
public class Big_Dice_Data_Model implements Serializable {
    ...
    @Expose
    private List<Big_Dice_Data_Item_> data;
    @Expose
    ...
    public List<Big_Dice_Data_Item_> getData() {
        return data;
    }

    public void setData(List<Big_Dice_Data_Item_> data) {
        this.data = data;
    }
