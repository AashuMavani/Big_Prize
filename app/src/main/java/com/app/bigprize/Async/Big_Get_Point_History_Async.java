...
public class Big_Get_Point_History_Async {
    private Activity activity;
    private JSONObject jObject;
    private BIG_AES_Cipher pocAesCipher;
    private String type;

    public Big_Get_Point_History_Async(final Activity activity, String type, String pageNo) {
        ...
        try {
            ...
            jObject.put("KLOPIOH", BIG_SharePrefs.getInstance().getBoolean(BIG_SharePrefs.IS_LOGIN) ? BIG_SharePrefs.getInstance().getString(BIG_SharePrefs.userToken) : BIG_Constants.getUSERTOKEN());
            ...
            jObject.put("5ROQHS", BIG_SharePrefs.getInstance().getInt(BIG_SharePrefs.todayOpen));
        ...
        try {
            ...
            if (responseModel.getStatus().equals(BIG_Constants.STATUS_LOGOUT)) {
                ...
                if (responseModel.getStatus().equals(BIG_Constants.STATUS_SUCCESS)) {
                    if (!type.equals(BIG_Constants.HistoryType.REFER_POINT) && !type.equals(BIG_Constants.HistoryType.REFER_USERS)) {
