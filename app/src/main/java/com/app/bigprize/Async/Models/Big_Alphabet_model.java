...
public class Big_Alphabet_model implements Serializable {
...
//    }
    ...
    @Expose
    private List<Big_Alphabet_Item> data;
    @Expose
    ...
    public List<Big_Alphabet_Item> getData() {
        return data;
    }

    public void setData(List<Big_Alphabet_Item> data) {
        this.data = data;
    }
