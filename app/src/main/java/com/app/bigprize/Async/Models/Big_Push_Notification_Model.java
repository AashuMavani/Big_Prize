...
public class Big_Push_Notification_Model {
    ...
    private Big_Push_Notification_Payload mPayload;
    ...
    public Big_Push_Notification_Payload getPayload() {
        return mPayload;
    }

    public void setPayload(Big_Push_Notification_Payload payload) {
        mPayload = payload;
    }
    ...
    public Big_Push_Notification_Payload getmPayload() {
        return mPayload;
    }

    public void setmPayload(Big_Push_Notification_Payload mPayload) {
